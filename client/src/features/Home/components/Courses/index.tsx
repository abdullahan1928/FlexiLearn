...
const postData: DataType[] = [
    {
        ...
        heading2: 'javascript',
        name: "Colt stelle",
        imgSrc: '/src/assets/src/assets/images/courses/courseone.png',
        students: 150,
        classes: 12,
        price: 20,
        rating: 4.7,
    },
    {
        ...
        name: "Colt stelle",
        imgSrc: '/src/assets/src/assets/images/courses/coursetwo.png',
        students: 130,
        classes: 12,
        price: 20,
        rating: 4.7,
    },
    {
        ...
        heading2: 'with Figma',
        name: "Colt stelle",
        imgSrc: '/src/assets/src/assets/images/courses/coursethree.png',
        students: 120,
        classes: 12,
        price: 20,
        rating: 4.7,
            ...
            <div id="courses">
                <div className='mx-auto max-w-7xl sm:py-8 px-4 lg:px-8 '>
                    ...
                    <div className="sm:flex justify-between items-center">
                        ...
                        <Link to={'/'} className="text-Blueviolet text-lg font-medium space-links">Explore courses&nbsp;&gt;&nbsp;</Link>
                    </div>
                                ...
                                <div className='bg-white m-3 px-3 pt-3 pb-12 my-20 shadow-courses rounded-2xl'>
                                    ...
                                    <div className="px-3">
                                        ...
                                        <div className="flex justify-between pt-6">
                                            <div className="flex gap-4">
                                                <img src={'/src/assets/src/assets/images/courses/book-open.svg'} alt="users" width={24} height={24} className="inline-block m-auto" />
                                                <h3 className="text-base font-medium text-black opacity-75">{items.classes} classes</h3>
                                            </div>
                                            <div className="flex gap-4">
                                                <img src={'/src/assets/src/assets/images/courses/users.svg'} alt="users" width={24} height={24} className="inline-block m-auto" />
